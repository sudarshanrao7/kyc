...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ApplicationCorrespondanceAddress',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, b'In Progress'), (2, b'Rejected'), (3, b'Success')], default=1)),
                ('consent', models.BooleanField(default=False)),
                ('correspondance_addresses', models.ManyToManyField(related_name='application_corresponding_address', to='eform.ApplicationCorrespondanceAddress')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_date', models.DateTimeField(blank=True, null=True)),
                ('remarks', models.TextField(blank=True)),
                ('application_form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eform.ApplicationForm')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='application_related_persons', to='eform.ApplicationRelatedPerson'),
        ),
        migrations.AddField(
            model_name='applicationform',
            name='user',
