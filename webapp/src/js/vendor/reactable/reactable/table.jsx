    ...
    parseChildData(props) {
        ...
        if (typeof(props.children) !== 'undefined') {
            React.Children.forEach(props.children, function(child) {
                ...
                if((child.type === Thead) ||  (child.type.name &&  child.type.name === "Thead" )){
                    return;
                }else if((child.type === Tfoot) ||  (child.type.name &&  child.type.name === "Tfoot" )){
                        if (typeof(tfoot) !== 'undefined') {
                            console.warn ('You can only have one <Tfoot>, but more than one was specified.' +
                                          'Ignoring all but the last one');
                        }
                        tfoot = child;                    
                }else if((child.type === Tr) ||  (child.type.name &&  child.type.name === "Tr" )){
    ...
    render() {
        ...
        if (this.props.children) {
            if (this.props.children.length > 0 &&
                 ...
                 (this.props.children[0].type.name
                  && this.props.children[0].type.name === "Thead" ))
            ) {
                firstChild = this.props.children[0];
            } else if (this.props.children.type === Thead ||  (this.props.children.type.name
                  && this.props.children.type.name === "Thead" )) {
        ...
        let isServerPaginate = this.props.isServerPaginate || false;
        let numPages = this.props.numPages ||  0;
        ...
        if (this.props.itemsPerPage > 0) {
            ...
            if(!isServerPaginate){
                ...
                numPages = Math.ceil(numPages / itemsPerPage);
                if(numPages < 0){
                     numPages = 0;   
                }else if(numPages === 1){
                    numPages = 0;   
